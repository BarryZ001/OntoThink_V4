        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center">
            ...
            <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
              我同意 <a href="#" className="text-primary-600 hover:text-primary-500">服务条款</a> 和 <a href="#" className="text-primary-600 hover:text-primary-500">隐私政策</a>
            </label>
          </div>
        ...
        <div className="mt-6">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-50 text-gray-500">或通过以下方式注册</span>
            </div>
          </div>
